...
export function RegistrationForm() {
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!form.get("universityId") || !form.get("email") || !form.get("firstName") || !form.get("lastName") || !form.get("dateOfBirth") || !form.get("gender") || !form.get("department") || !form.get("faculty") || !form.get("confirm") || !passwordValid || password !== confirmPassword) return;
